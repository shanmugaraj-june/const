...
const services = [
  {
    ...
    description: 'Custom homes, renovations, and residential improvements tailored to your lifestyle and budget.',
    points: [
  ...
  },
  {
    ...
    description: 'Expert consultation and design services to bring your vision to life with practical solutions.',
    points: [
   ...
   <Header />   
     <section className="service-section">
      ...
      <p className="section-subtitle">
        From residential homes to commercial buildings, we offer comprehensive construction services to meet all your building needs.
      </p>
      <div className="service-cards">
        {services.map((service, index) => (
          <div className="card fade-in" key={index} style={{ animationDelay: `${index * 0.3}s` }}>
            ...
            {service.link && <a href={service.link} className="learn-link">Learn More →</a>}
          </div>
        ))}
      </div>
    </section>
